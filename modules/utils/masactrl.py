...
class MutualSelfAttentionControl(AttentionBase):
    ...
    def __init__(self, start_step: int=4, start_layer: int=10, layer_idx: None=None, step_idx: None=None, total_steps: int=50, model_type: str="SD") -> None:
        """
    ...
    def attn_batch(self, q: torch.Tensor, k: torch.Tensor, v: torch.Tensor, sim: torch.Tensor, attn: torch.Tensor, is_cross: bool, place_in_unet: str, num_heads: int, **kwargs) -> torch.Tensor:
        """
